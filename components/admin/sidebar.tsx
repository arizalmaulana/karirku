...
import { LayoutDashboard, Briefcase, Users, Wallet, FileText, Building2, X } from 'lucide-react';
    ...
    return (
        <>
            ...
            `}>
                ...
                {/* LOGO HEADER */}
                <div className="h-20 flex items-center justify-between px-6 border-b border-gray-200/60 bg-gradient-to-r from-indigo-50/50 to-purple-50/50">
